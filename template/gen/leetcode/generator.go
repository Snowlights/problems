...
func (p *problem) writeTestFile() error {
	logInfo := ""
	testUtilFunc := "leetcode.RunLeetCodeFuncWithFile"
	if !p.isFuncProblem {
		logInfo += "\n\t" + `t.Log("记得初始化所有全局变量")`
		testUtilFunc = "leetcode.RunLeetCodeClassWithFile"
	}
	...
	testStr := fmt.Sprintf(`// Code generated by template/gen/leetcode/generator_test.go
package main
