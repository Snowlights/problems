...
func TestA(t *testing.T) {
	...
	//}
	//targetCaseNum := 0 // -1
	//if err := leetcode.RunLeetCodeFuncWithExamples(t, minimumSwitchingTimes, examples, targetCaseNum); err != nil {
	//	t.Fatal(err)
	//}
	...
	//targetCaseNum := 0
	//if err := leetcode.RunLeetCodeFuncWithCase(t, minimumSwitchingTimes, exampleIns, exampleOuts, targetCaseNum); err != nil {
	//	t.Fatal(err)
	//}
