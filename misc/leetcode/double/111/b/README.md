...
我们考虑 str1 的前 i 位可以得到 str2 的前多少位字符。

而对于这个问题，我们只需要贪心地看 str1 的下一个字符能否变成 str2 的下一个字符，如果行，能成为子序列的 str2 中的字符数量加一；否则不变。

对于检查能否转变，我们可以使用其 ascii 码等比较。

最后看是否到达 str2 的最后一个字符。
